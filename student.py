...
class Student:
    def __init__(self,root):
        ...
        self.var_teacher=StringVar()
         ...
         # 1st image
        img=Image.open(r"C:\Users\vg180\OneDrive\Desktop\face recognition attendance system\student images\student1.jpeg")
        ...
        #2nd image
        img1=Image.open(r"C:\Users\vg180\OneDrive\Desktop\face recognition attendance system\student images\student2.jpeg")
        ...
        #3rd image
        img2=Image.open(r"C:\Users\vg180\OneDrive\Desktop\face recognition attendance system\student images\student3.jpeg")
        ...
        #4th image
        img3=Image.open(r"C:\Users\vg180\OneDrive\Desktop\face recognition attendance system\student images\student4.jpeg")
        ...
        title_lbl=Label(bg_img,text="STUDENT DETAILS",font=("times new roman",25,"bold"),bg="white",fg="dark blue")
        ...
        img_left=Image.open(r"C:\Users\vg180\OneDrive\Desktop\face recognition attendance system\student images\student6.jpeg")
        ...
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Correct Course Information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=5,y=135,width=680,height=180)
        ...
        dep_combo["values"]=("Select Department","Computer Science","IT Department","B.C.A","Civil","Mechanical","Minning","Diploma")
        dep_combo.current(0)
        ...
        btn_frame.place(x=0,y=150,width=680,height=35)
        ...
        #2nd Button Frame for take photo and update 
        btn_frame1=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=180,width=680,height=35)
        ...
        search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Search ystem",font=("times new roman",12,"bold"))
        ...
        search_combo["values"]=("Select","Roll_No.","Phone","semester-3","Semester-4","Semester-5","Semester-6","Semester-7","Semester-8")
        ...
        table_frame.place(x=5,y=175,width=650,height=350)
        ...
        self.student_table.heading("photo",text="PhotoSampleId")
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                upadate=messagebox.askyesno("Update","Are you sure to update",parent=self.root)
                if upadate>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="vishalgupta@9123",database="face_recognizer")
                    my_cursor=conn.cursor()
...
#----------------------- Delete Function -----------------------------
    def delete_data(self):
        if self.va_std_id.get()=="":
            ...
            try:
                delete=messagebox.askyesno("Delete","Do you wanr to delete",parent=self.root)
                if delete>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="vishalgupta@9123",database="face_recognizer")
                    my_cursor=conn.cursor()   
